...
**卷积神经网络**（Convolutional Neural Network，CNN）正是为解决这两个问题而生。1998 年，法国计算机科学家杨立昆（Yann LeCun，图灵奖得主）在图像领域里程碑论文《Gradient-Based Learning Applied to Document Recognition》中提出了 LeNet-5 网络，这是第一个在工业界大规模成功应用的卷积神经网络。LeNet-5 被用于手写数字识别，在美国银行支票读取系统中得到实际应用。
