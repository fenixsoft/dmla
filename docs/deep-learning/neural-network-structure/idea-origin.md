...
- 1960 年代：**高潮与低谷**
    ...
    转折出现在 1969 年。明斯基和西摩·派普特（Seymour Papert）出版《Perceptrons》一书，对感知机的能力提出了尖锐批评。书中证明感知机无法解决**异或问题**（XOR Problem），因为 XOR 是非线性可分的。一个简单的两层神经网络就能解决 XOR 问题，但当时的理论无法有效训练多层网络。这本书的影响巨大，导致神经网络研究陷入长达十年的低谷。
