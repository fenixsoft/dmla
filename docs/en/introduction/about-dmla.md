...
In my outline, "[Designing Machine Learning Applications](https://ai.icyfenix.cn)" (DMLA) will span about 700,000 Chinese characters, making it the longest among the nine computer books I have published, and also the most technically intensive. Learning energy is a finite resource, so I hope you will take a moment before diving in to read this article and decide whether this document is what you need, and whether its approach suits where you are right now.
