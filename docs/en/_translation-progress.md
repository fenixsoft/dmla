...
| deep-learning/neural-network-stability/batch-normalization.md | 翻译完成 | ✓ | | LaTeX/Markdown 不变；代码注释译英；内部 `.md` 链接锚点译英（`#batch-computation-and-efficiency-optimization`、`#layer-normalization`）；无图片引用需修复 |
