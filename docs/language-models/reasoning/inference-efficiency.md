...
2023 年，Google 的亚尼夫·列维坦（Yaniv Leviathan）在论文《[Fast Inference from Transformers via Speculative Decoding](https://arxiv.org/abs/2211.17192)》中提出了投机解码，这是一种更有创造力的效率改进策略，它改变了语言模型生成 token 的方式，从"逐个生成"变为"先猜后验"，让 GPU 的计算资源在 Decode 阶段也能被充分利用。
