...
在我准备的提纲里，《[设计机器学习应用系统](https://ai.icyfenix.cn)》（DMLA）会有 70 万字的篇幅，是我出版过的九部计算机书籍中最长的，内容也最为硬核。人的学习精力是一种有限的资源，希望你能在开始之前，先花费一点点时间阅读本文，确定这部文档是否你所需要的，以及它的讲述方式是否适合于你现在的状态。
